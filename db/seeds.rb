...
Item.create!([
  {title: "Rachel's Futon",         description: "Comfortable wood framed futon.",              price: 2700,   max_quantity: 500, scarcity: "endangered", people_per_unit: 1, bathroom: "Private", user_id: 1 },
  {title: "Jorge's Couch",          description: "Clean pull out couch.",                       price: 177600, max_quantity: 500, scarcity: "endangered", people_per_unit: 2, bathroom: "Shared",  user_id: 2 },
  {title: "Josh's Twin Bed",        description: "Large room with desk and twin bed.",          price: 133700, max_quantity: 500, scarcity: "endangered", people_per_unit: 1, bathroom: "Private", user_id: 4 },
  {title: "Jeff's Futon",           description: "Quaint futon.",                               price: 1200,   max_quantity: 500, scarcity: "endangered", people_per_unit: 2, bathroom: "Private", user_id: 5 },
  {title: "Emily's Hammock",        description: "Hammock strung up over bathtub.",             price: 2000,   max_quantity: 500, scarcity: "endangered", people_per_unit: 1, bathroom: "Shared",  user_id: 6 },
  {title: "Will's King Bed",        description: "King size bed.",                              price: 1400,   max_quantity: 500, scarcity: "endangered", people_per_unit: 2, bathroom: "Shared",  user_id: 7 },
  {title: "Gustavo's La-z-boy",     description: "Semi-lumpy La-z-boy.",                        price: 8000,   max_quantity: 500, scarcity: "endangered", people_per_unit: 1, bathroom: "Private", user_id: 8 },
  {title: "Eric's Queen Bed",       description: "Sunny second floor bedroom with queen bed.",  price: 3300,   max_quantity: 500, scarcity: "endangered", people_per_unit: 1, bathroom: "Private", user_id: 10 },
  {title: "Emily's NorthFace Tent", description: "NorthFace tent on well appointed balcony.",   price: 3200,   max_quantity: 500, scarcity: "endangered", people_per_unit: 3, bathroom: "Shared",  user_id: 6 },
  {title: "Will's Studio",          description: "Charming downtown studio.",                   price: 300,    max_quantity: 500, scarcity: "endangered", people_per_unit: 2, bathroom: "Shared",  user_id: 7 },
  {title: "Gustavo's Couch",        description: "Loft with pull out couch.",                   price: 600,    max_quantity: 500, scarcity: "endangered", people_per_unit: 1, bathroom: "Private", user_id: 8 },
  {title: "Marc's Couch",           description: "Super comfortable couch.",                    price: 2400,   max_quantity: 500, scarcity: "endangered", people_per_unit: 1, bathroom: "Private", user_id: 9 },
